...
const Tabs: React.FC<TabsProps> = props => {
  ...
  return (
    ...
    >
      <div className='vikasit-email-editor-tabWrapper'>
        <Stack
                ...
                return (
                  <div
                    ...
                    className={classnames(
                      'vikasit-email-editor-tabItem',
                      !activeTab && index === 0 && 'vikasit-email-editor-tabActiveItem',
                      activeTab === item.key && 'vikasit-email-editor-tabActiveItem',
                    )}
                  >
                    <Button noBorder>
                      <>{item.props.tab}</>
