...
This is the core vikasit-email library, composed by the following parts
...
```sh
$ npm install --save vikasit-email-core
```

or

```sh
$ yarn add vikasit-email-core
```

## transform json to mjml

```ts
import { JsonToMjml } from 'vikasit-email-core';
...
```tsx
import { JsonToMjml, components, parseReactBlockToBlockData } from 'vikasit-email-core';
    ...
    const defaultData: IMyFirstBlock = {
      ...
      data: {
        value: {
          buttonText: 'Got it',
          imageUrl:
            'http://static.vikasit.com/dwkp0e1yo/image/upload/v1665841616/pn7npfspxaqfzxiensue.png',
        },
      },
      attributes: {
    ...
    >
      ...
      >
        <mj-image
          ...
          height="auto"
          padding="0px 0px 0px 0px"
          src="http://static.vikasit.com/dwkp0e1yo/image/upload/v1665841616/pn7npfspxaqfzxiensue.png"
          width="100px"
        >
        </mj-image>
