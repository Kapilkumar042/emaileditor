...
import { BasicType, getParentIdx, getSiblingIdx } from 'vikasit-email-core';
import { useBlock, useFocusIdx, useEditorProps, isTextBlock } from 'vikasit-email-editor';
...
export function Toolbar() {
  ...
  return (
    <>
      <div
        id='vikasit-email-extensions-InteractivePrompt-Toolbar'
        style={{
          height: 0,
