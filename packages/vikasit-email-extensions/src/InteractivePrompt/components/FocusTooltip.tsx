...
import { IconFont, useBlock, useFocusIdx, BlockAvatarWrapper, useFocusBlockLayout } from 'vikasit-email-editor';
...
export function FocusTooltip() {
  ...
  return (
    <>
      {createPortal(
        <div
          id='vikasit-email-extensions-InteractivePrompt-FocusTooltip'
          style={{
            position: 'absolute',
            width: '100%',
            height: '100%',
