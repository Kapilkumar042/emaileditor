...
import { getNodeTypeFromClassName, BlockManager } from 'vikasit-email-core';
import { createPortal } from 'react-dom';
import { getEditorRoot, useEditorContext, useFocusIdx, useHoverIdx, useLazyState } from 'vikasit-email-editor';
...
export function HoverTooltip() {
  ...
  return (
    <>
      {createPortal(
        <div
          id='vikasit-email-extensions-InteractivePrompt-HoverTooltip'
          style={{
            position: 'absolute',
            height: '100%',
            width: '100%',
