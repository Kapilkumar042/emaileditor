...
<mj-html-attributes>
<mj-html-attribute class="vikasit-email" multiple-attributes="false" attribute-name="text-color" text-color="#000000"></mj-html-attribute>
<mj-html-attribute class="vikasit-email" multiple-attributes="false" attribute-name="font-family" font-family="'Hiragino Kaku Gothic ProN','Hiragino Sans',Meiryo"></mj-html-attribute>
<mj-html-attribute class="vikasit-email" multiple-attributes="false" attribute-name="responsive" responsive="true"></mj-html-attribute>
...
describe('Test parseXml', () => {
  ...
  it('should render  as expected', () => {
    ...
    <mj-text font-size="13px" padding="0px 0px 0px 0px" line-height="1" align="left">
     <div style="color:#fff;">Make it simple for everyone to compose emails!</div>
    </mj-text>
  `)
    ).toMatchSnapshot();
  });
