...
export default defineConfig({
  resolve: {
    alias: {
      ...
      'vikasit-email-core': path.resolve('../packages/vikasit-email-core'),
      'vikasit-email-editor': path.resolve('../packages/vikasit-email-editor'),
      'vikasit-email-extensions': path.resolve('../packages/vikasit-email-extensions'),
    },
  },
  optimizeDeps: {},
  define: {},
