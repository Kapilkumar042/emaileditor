...
const create: CreateInstance<IText> = payload => {
  const defaultData: IText = {
    ...
    data: {
      value: {
        content: 'Make it simple for everyone to compose emails!',
      },
    },
    attributes: {
      'font-size': '13px',
...
```tsx
import { Button } from 'vikasit-email-editor';
...
```ts
import { BlocksMap } from 'vikasit-email-editor';
...
[https://github.com/myvikasit/vikasit-email-demo/tree/main/src/CustomBlocks](https://github.com/myvikasit/vikasit-email-demo/tree/main/src/CustomBlocks)
...
```tsx
import { IBlockData, BasicType, components, createCustomBlock } from 'vikasit-email-core';
...
const productPlaceholder = {
  ...
  price: '$59.99 HKD',
  url: 'https://vikasit-email-myvikasit.vercel.app',
};
